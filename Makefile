...
help:
	@echo "\033[33mOmni\033[0m \`make T\` - (T)argets:"
	@echo ""
	@echo "\033[32mBuild & Package:\033[0m"
	...
	@echo ""
	@echo "\033[32mIntegration Testing:\033[0m"
	...
	@echo ""
	@echo "\033[32mPerformance:\033[0m"
	@printf "  \033[36m%-25s\033[0m %s\n" "bench"               "Run benchmarks"
	@printf "  \033[36m%-25s\033[0m %s\n" "bench-full"          "Run comprehensive benchmarks (10s)"
	@echo ""
	@echo "\033[32mDeployment & Dependencies:\033[0m"
	...
	@echo ""
	@echo "\033[32mExamples:\033[0m"
	@printf "  \033[36m%-25s\033[0m %s\n" "run-examples"        "Run all example applications"
	@echo ""
	@echo "\033[32mGit Hooks:\033[0m"

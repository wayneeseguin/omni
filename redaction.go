...
func (f *FlexLog) FlogRequest(method, path string, headers map[string][]string, body string) {
...
func (f *FlexLog) FlogResponse(statusCode int, headers map[string][]string, body string) {
	safeHeaders := make(map[string][]string)
